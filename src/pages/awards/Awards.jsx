...
const Awards = () => {
    ...
    const { accounts, searchAccountByNameOrEmail, error, loading } =
        useAccounts({ search });
    ...
    const debouncedsearchAccountByNameOrEmail = useCallback(
        debounce(search => {
    ...
    const handleSearchChange = e => {
        ...
        setSearch(newSearch);
        debouncedsearchAccountByNameOrEmail(newSearch);
    };
